...
if ( $social_params['google'] == 'yes' ) {
    ...
    if ( $social_params['google_type'] != 'share' ) {
        wc_get_template( '/frontend/gp-plusone-btn.php', array( 'social_params' => $social_params ), YWSFD_TEMPLATE_PATH, YWSFD_TEMPLATE_PATH );
    }

    if ( $social_params['google_type'] != 'plusone' ) {
        wc_get_template( '/frontend/gp-share-btn.php', array( 'social_params' => $social_params ), YWSFD_TEMPLATE_PATH, YWSFD_TEMPLATE_PATH );
    }
